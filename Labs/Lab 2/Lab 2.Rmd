...
It is clear from the table above that there are multiple carriers using the same flight number.

If we know the flight number, carrier, and origin, can we know for sure what the destination will be? (*Yes/No*)

No.

Why or why not?

In the table above, flight number 807 with carrier UA and origin EWR has multiple different destinations, including MCO, LAS, IAH, and BOS.
