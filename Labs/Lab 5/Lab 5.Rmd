...
untidy3.school = untidy2.school %>%
                    ...
                    gather(`2017`:`2018`, key = "Year", value = "Value", convert = TRUE)
...
More money should be distributed to the schools that showed the most improvement in the area of mathematics, while the schoools with the least improvement should be given the least.
...
Based on the graph of score versus year, it appears that students did actually improve their math knowledge. There was a very wide range of scores in 2017 ranging from 20 to about 76, while in 2018, the range was much smaller, at about 64-85. When comparing the students to each other, it appears that the schools may have mainly focused on the students who were under-performing in math. Many of the students who were below the 50th percentile in 2017 switched to above the 50th percentile in 2018, and vice versa for those above the 50th in 2017.
